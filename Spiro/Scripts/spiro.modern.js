...
(function (Spiro) {
    (function (Modern) {
        ...
        var ControllerFactory = (function () {
            ...
            ControllerFactory.servicesController = function servicesController(model, options) {
                pageController.changeModel(model);
                return new ServicesController(model, options);
            };
            ControllerFactory.objectController = function objectController(model, options) {
                if(options.nest) {
            ...
            ControllerFactory.CreateControllerAndFetch = function CreateControllerAndFetch(model, options) {
                var controller = ControllerFactory.CreateController(model, options);
                model.fetch();
                return controller;
            };
            ControllerFactory.CreateControllerAndDraw = function CreateControllerAndDraw(model, options) {
                var controller = ControllerFactory.CreateController(model, options);
                model.trigger("draw");
                return controller;
            };
            ControllerFactory.CreateController = function CreateController(model, options) {
        ...
        var ListController = (function (_super) {
            ...
            function ListController(model, options) {
                ...
                this.listPresentation = Modern.presentationFactory.CreatePresentation(this.model, {
                    list: true
                });
                this.tablePresentation = Modern.presentationFactory.CreatePresentation(this.model, {
                    table: true
                });
        ...
        var DomainObjectController = (function (_super) {
            ...
            function DomainObjectController(model, options) {
                ...
                this.editPresentation = Modern.presentationFactory.CreatePresentation(this.model, {
                    edit: true
                });
            ...
            DomainObjectController.prototype.action = function (aId) {
                if(this.model.actionMember(aId).extensions().hasParams) {
                    ...
                    ControllerFactory.CreateControllerAndFetch(action, {
                        nest: true
                    });
                } else {
                    var actionResult = Spiro.Helpers.createActionInvoke(this.model, aId);
                    ControllerFactory.CreateControllerAndFetch(actionResult, {
                        nest: true
                    });
                }
            };
