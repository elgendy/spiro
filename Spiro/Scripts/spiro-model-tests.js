...
(function (SpiroModelTests) {
    ...
    asyncTest("Proto Persistent DomainObject Resource", function () {
        ...
        invoke.method = "POST";
        invoke.setParameter("vendor", new Spiro.Value({
            "href": "http://mvc.nakedobjects.net:1081/RestDemo/objects/AdventureWorksModel.Vendor/32"
        }));
        invoke.fetch();
    });
    asyncTest("Proto Persistent DomainObject Resource save", function () {
        ...
        test.doTest = function () {
            ...
            persistMap.setMember("OrderPlacedBy", new Spiro.Value({
                "href": "http://mvc.nakedobjects.net:1081/RestDemo/objects/AdventureWorksModel.Employee/165"
            }));
            persistMap.setMember("ShipMethod", new Spiro.Value({
                "href": "http://mvc.nakedobjects.net:1081/RestDemo/objects/AdventureWorksModel.ShipMethod/4"
            }));
            persistMap.save();
        };
        invoke.hateoasUrl = "http://mvc.nakedobjects.net:1081/RestDemo/services/AdventureWorksModel.PurchaseOrderRepository/actions/CreateNewPurchaseOrder/invoke";
            ...
            var mData = [
                {
                    ...
                    mo: 10,
                    opt: false,
                    rt: "AdventureWorksModel.Product",
                    dr: undefined
                }, 
                {
                    key: "OrderQty",
                ...
                }, 
                {
                    ...
                    mo: 26,
                    opt: true,
                    rt: "AdventureWorksModel.ScrapReason",
                    dr: undefined
                }, 
                {
                    key: "StartDate",
                    value: "2001-08-27T23:00:00Z",
                    fn: "Start Date",
                    mo: 30,
                    opt: false,
                    rt: "string",
    ...
    asyncTest("Update Domain Object reference ok", function () {
        ...
        test.doTest = function () {
            ...
            if(oldShipMethod.toString() == "CARGO TRANSPORT 5") {
                newShipMethod = new Spiro.Value({
                    "href": "http://mvc.nakedobjects.net:1081/RestDemo/objects/AdventureWorksModel.ShipMethod/4"
                });
                newTitle = "OVERNIGHT J-FAST";
            } else {
                newShipMethod = new Spiro.Value({
                    "href": "http://mvc.nakedobjects.net:1081/RestDemo/objects/AdventureWorksModel.ShipMethod/5"
                });
        ...
        test.doTest = function () {
            ...
            var mData = {
                Product: {
                    key: "Product",
                    value: {
                        href: "http://mvc.nakedobjects.net:1081/RestDemo/objects/AdventureWorksModel.Product/531"
                    },
                    fn: "Product",
                    mo: 10,
                    opt: false,
...
//@ sourceMappingURL=spiro-model-tests.js.map
